...
volatile int       inputBufferCount;  
int                inputUnderflowCount;
int                inputOverflowCount;
volatile int       outputBufferCount;  
...
testParamsPtr->streamFlags = paClipOff;  
...
const int intInput[] = { 2147483647, 2147483647/2, -1073741824  , -2147483648 };
float floatOutput[4];
short shortOutput[4];
int intOutput[4];
