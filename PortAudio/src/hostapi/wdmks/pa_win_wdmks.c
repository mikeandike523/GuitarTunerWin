...
PaUtil_GroupFreeMemory( winDsHostApi->allocations, scanDeviceInfosResults->deviceInfos[0] );  
...
{
hostInputSampleFormat = (PaSampleFormat)0;  
...
{
hostOutputSampleFormat = (PaSampleFormat)0;  
