...
const char * TARGET_PROGRAM_NAME = "patest_maxsines";  
...
fputs ("#! /bin/sh\n", f);
fputs ("\n", f);
fputs ("# bin/patest_maxsines - temporary wrapper script for .libs/patest_maxsines\n", f);
fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7ubuntu1\n", f);
fputs ("#\n", f);
fputs ("# The bin/patest_maxsines program cannot be directly executed until all the lib", f);
fputs ("tool\n", f);
...
fputs ("    echo \"patest_maxsines:bin/patest_maxsines:${LINENO}: libtool wrapper (GNU l", f);
...
fputs ("  for lt_arg\n", f);
fputs ("  do\n", f);
fputs ("    $ECHO \"patest_maxsines:bin/patest_maxsines:${LINENO}: newargv[$lt_dump_args", f);
fputs ("_N]: $lt_arg\"\n", f);
...
fputs ("\n", f);
fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
fputs ("        $ECHO \"patest_maxsines:bin/patest_maxsines:${LINENO}: newargv[0]: $prog", f);
