...
const char * TARGET_PROGRAM_NAME = "patest_prime";  
...
fputs ("#! /bin/sh\n", f);
fputs ("\n", f);
fputs ("# bin/patest_prime - temporary wrapper script for .libs/patest_prime\n", f);
fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7ubuntu1\n", f);
fputs ("#\n", f);
fputs ("# The bin/patest_prime program cannot be directly executed until all the libtoo", f);
fputs ("l\n", f);
...
fputs ("    echo \"patest_prime:bin/patest_prime:${LINENO}: libtool wrapper (GNU libtool", f);
fputs (") 2.4.2 Debian-2.4.2-1.7ubuntu1\" 1>&2\n", f);
fputs ("  fi\n", f);
fputs ("}\n", f);
fputs ("\n", f);
...
fputs ("  for lt_arg\n", f);
fputs ("  do\n", f);
fputs ("    $ECHO \"patest_prime:bin/patest_prime:${LINENO}: newargv[$lt_dump_args_N]: $", f);
fputs ("lt_arg\"\n", f);
...
fputs ("\n", f);
fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
fputs ("        $ECHO \"patest_prime:bin/patest_prime:${LINENO}: newargv[0]: $progdir/$p", f);
fputs ("rogram\" 1>&2\n", f);
