...
const char * TARGET_PROGRAM_NAME = "patest_sine8";  
...
fputs ("#! /bin/sh\n", f);
fputs ("\n", f);
fputs ("# bin/patest_sine8 - temporary wrapper script for .libs/patest_sine8\n", f);
fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7ubuntu1\n", f);
fputs ("#\n", f);
fputs ("# The bin/patest_sine8 program cannot be directly executed until all the libtoo", f);
fputs ("l\n", f);
...
fputs ("    echo \"patest_sine8:bin/patest_sine8:${LINENO}: libtool wrapper (GNU libtool", f);
...
fputs ("  for lt_arg\n", f);
fputs ("  do\n", f);
fputs ("    $ECHO \"patest_sine8:bin/patest_sine8:${LINENO}: newargv[$lt_dump_args_N]: $", f);
fputs ("lt_arg\"\n", f);
...
fputs ("\n", f);
fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
fputs ("        $ECHO \"patest_sine8:bin/patest_sine8:${LINENO}: newargv[0]: $progdir/$p", f);
fputs ("rogram\" 1>&2\n", f);
