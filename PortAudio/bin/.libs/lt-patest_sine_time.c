...
const char * TARGET_PROGRAM_NAME = "patest_sine_time";  
...
fputs ("#! /bin/sh\n", f);
fputs ("\n", f);
fputs ("# bin/patest_sine_time - temporary wrapper script for .libs/patest_sine_time\n", f);
fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7ubuntu1\n", f);
fputs ("#\n", f);
fputs ("# The bin/patest_sine_time program cannot be directly executed until all the li", f);
fputs ("btool\n", f);
...
fputs ("    echo \"patest_sine_time:bin/patest_sine_time:${LINENO}: libtool wrapper (GNU", f);
...
fputs ("  for lt_arg\n", f);
fputs ("  do\n", f);
fputs ("    $ECHO \"patest_sine_time:bin/patest_sine_time:${LINENO}: newargv[$lt_dump_ar", f);
fputs ("gs_N]: $lt_arg\"\n", f);
...
fputs ("\n", f);
fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
fputs ("        $ECHO \"patest_sine_time:bin/patest_sine_time:${LINENO}: newargv[0]: $pr", f);
...
fputs ("\n", f);
fputs ("  program='patest_sine_time'\n", f);
