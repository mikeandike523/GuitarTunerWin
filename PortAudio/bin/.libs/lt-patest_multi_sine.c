...
const char * TARGET_PROGRAM_NAME = "patest_multi_sine";  
...
fputs ("#! /bin/sh\n", f);
fputs ("\n", f);
fputs ("# bin/patest_multi_sine - temporary wrapper script for .libs/patest_multi_sine\n", f);
fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7ubuntu1\n", f);
fputs ("#\n", f);
fputs ("# The bin/patest_multi_sine program cannot be directly executed until all the l", f);
fputs ("ibtool\n", f);
...
fputs ("    echo \"patest_multi_sine:bin/patest_multi_sine:${LINENO}: libtool wrapper (G", f);
...
fputs ("  for lt_arg\n", f);
fputs ("  do\n", f);
fputs ("    $ECHO \"patest_multi_sine:bin/patest_multi_sine:${LINENO}: newargv[$lt_dump_", f);
fputs ("args_N]: $lt_arg\"\n", f);
...
fputs ("\n", f);
fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
fputs ("        $ECHO \"patest_multi_sine:bin/patest_multi_sine:${LINENO}: newargv[0]: $", f);
...
fputs ("\n", f);
fputs ("  program='patest_multi_sine'\n", f);
