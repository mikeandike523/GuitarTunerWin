...
const char * TARGET_PROGRAM_NAME = "paex_write_sine";  
...
fputs ("#! /bin/sh\n", f);
fputs ("\n", f);
fputs ("# bin/paex_write_sine - temporary wrapper script for .libs/paex_write_sine\n", f);
fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7ubuntu1\n", f);
fputs ("#\n", f);
fputs ("# The bin/paex_write_sine program cannot be directly executed until all the lib", f);
fputs ("tool\n", f);
...
fputs ("    echo \"paex_write_sine:bin/paex_write_sine:${LINENO}: libtool wrapper (GNU l", f);
fputs ("ibtool) 2.4.2 Debian-2.4.2-1.7ubuntu1\" 1>&2\n", f);
fputs ("  fi\n", f);
fputs ("}\n", f);
fputs ("\n", f);
...
fputs ("  for lt_arg\n", f);
fputs ("  do\n", f);
fputs ("    $ECHO \"paex_write_sine:bin/paex_write_sine:${LINENO}: newargv[$lt_dump_args", f);
fputs ("_N]: $lt_arg\"\n", f);
...
fputs ("\n", f);
fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
fputs ("        $ECHO \"paex_write_sine:bin/paex_write_sine:${LINENO}: newargv[0]: $prog", f);
fputs ("dir/$program\" 1>&2\n", f);
