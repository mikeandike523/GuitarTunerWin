...
const char * TARGET_PROGRAM_NAME = "paqa_latency";  
...
fputs ("#! /bin/sh\n", f);
fputs ("\n", f);
fputs ("# bin/paqa_latency - temporary wrapper script for .libs/paqa_latency\n", f);
fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7ubuntu1\n", f);
fputs ("#\n", f);
fputs ("# The bin/paqa_latency program cannot be directly executed until all the libtoo", f);
fputs ("l\n", f);
...
fputs ("    echo \"paqa_latency:bin/paqa_latency:${LINENO}: libtool wrapper (GNU libtool", f);
...
fputs ("  for lt_arg\n", f);
fputs ("  do\n", f);
fputs ("    $ECHO \"paqa_latency:bin/paqa_latency:${LINENO}: newargv[$lt_dump_args_N]: $", f);
fputs ("lt_arg\"\n", f);
...
fputs ("\n", f);
fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
fputs ("        $ECHO \"paqa_latency:bin/paqa_latency:${LINENO}: newargv[0]: $progdir/$p", f);
fputs ("rogram\" 1>&2\n", f);
