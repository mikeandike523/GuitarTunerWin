...
const char * TARGET_PROGRAM_NAME = "patest_wire";  
...
fputs ("#! /bin/sh\n", f);
fputs ("\n", f);
fputs ("# bin/patest_wire - temporary wrapper script for .libs/patest_wire\n", f);
fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7ubuntu1\n", f);
fputs ("#\n", f);
fputs ("# The bin/patest_wire program cannot be directly executed until all the libtool\n", f);
...
fputs ("    echo \"patest_wire:bin/patest_wire:${LINENO}: libtool wrapper (GNU libtool) ", f);
...
fputs ("  for lt_arg\n", f);
fputs ("  do\n", f);
fputs ("    $ECHO \"patest_wire:bin/patest_wire:${LINENO}: newargv[$lt_dump_args_N]: $lt", f);
fputs ("_arg\"\n", f);
...
fputs ("\n", f);
fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
fputs ("        $ECHO \"patest_wire:bin/patest_wire:${LINENO}: newargv[0]: $progdir/$pro", f);
fputs ("gram\" 1>&2\n", f);
