...
const char * TARGET_PROGRAM_NAME = "paqa_errs";  
...
fputs ("#! /bin/sh\n", f);
fputs ("\n", f);
fputs ("# bin/paqa_errs - temporary wrapper script for .libs/paqa_errs\n", f);
fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7ubuntu1\n", f);
fputs ("#\n", f);
fputs ("# The bin/paqa_errs program cannot be directly executed until all the libtool\n", f);
...
fputs ("    echo \"paqa_errs:bin/paqa_errs:${LINENO}: libtool wrapper (GNU libtool) 2.4.", f);
fputs ("2 Debian-2.4.2-1.7ubuntu1\" 1>&2\n", f);
fputs ("  fi\n", f);
fputs ("}\n", f);
fputs ("\n", f);
...
fputs ("  for lt_arg\n", f);
fputs ("  do\n", f);
fputs ("    $ECHO \"paqa_errs:bin/paqa_errs:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg", f);
fputs ("\"\n", f);
...
fputs ("\n", f);
fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
fputs ("        $ECHO \"paqa_errs:bin/paqa_errs:${LINENO}: newargv[0]: $progdir/$program", f);
fputs ("\" 1>&2\n", f);
