...
const char * TARGET_PROGRAM_NAME = "patest_ringmix";  
...
fputs ("#! /bin/sh\n", f);
fputs ("\n", f);
fputs ("# bin/patest_ringmix - temporary wrapper script for .libs/patest_ringmix\n", f);
fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7ubuntu1\n", f);
fputs ("#\n", f);
fputs ("# The bin/patest_ringmix program cannot be directly executed until all the libt", f);
fputs ("ool\n", f);
...
fputs ("    echo \"patest_ringmix:bin/patest_ringmix:${LINENO}: libtool wrapper (GNU lib", f);
fputs ("tool) 2.4.2 Debian-2.4.2-1.7ubuntu1\" 1>&2\n", f);
fputs ("  fi\n", f);
fputs ("}\n", f);
fputs ("\n", f);
...
fputs ("  for lt_arg\n", f);
fputs ("  do\n", f);
fputs ("    $ECHO \"patest_ringmix:bin/patest_ringmix:${LINENO}: newargv[$lt_dump_args_N", f);
fputs ("]: $lt_arg\"\n", f);
...
fputs ("\n", f);
fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
fputs ("        $ECHO \"patest_ringmix:bin/patest_ringmix:${LINENO}: newargv[0]: $progdi", f);
fputs ("r/$program\" 1>&2\n", f);
