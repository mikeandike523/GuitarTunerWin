...
const char * TARGET_PROGRAM_NAME = "patest_callbackstop";  
...
fputs ("#! /bin/sh\n", f);
fputs ("\n", f);
fputs ("# bin/patest_callbackstop - temporary wrapper script for .libs/patest_callbacks", f);
fputs ("top\n", f);
fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7ubuntu1\n", f);
fputs ("#\n", f);
fputs ("# The bin/patest_callbackstop program cannot be directly executed until all the", f);
fputs (" libtool\n", f);
...
fputs ("    echo \"patest_callbackstop:bin/patest_callbackstop:${LINENO}: libtool wrappe", f);
...
fputs ("  for lt_arg\n", f);
fputs ("  do\n", f);
fputs ("    $ECHO \"patest_callbackstop:bin/patest_callbackstop:${LINENO}: newargv[$lt_d", f);
...
fputs ("\n", f);
fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
fputs ("        $ECHO \"patest_callbackstop:bin/patest_callbackstop:${LINENO}: newargv[0", f);
...
fputs ("\n", f);
fputs ("  program='patest_callbackstop'\n", f);
