...
const char * TARGET_PROGRAM_NAME = "patest_sine_srate";  
...
fputs ("#! /bin/sh\n", f);
fputs ("\n", f);
fputs ("# bin/patest_sine_srate - temporary wrapper script for .libs/patest_sine_srate\n", f);
fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7ubuntu1\n", f);
fputs ("#\n", f);
fputs ("# The bin/patest_sine_srate program cannot be directly executed until all the l", f);
fputs ("ibtool\n", f);
...
fputs ("    echo \"patest_sine_srate:bin/patest_sine_srate:${LINENO}: libtool wrapper (G", f);
fputs ("NU libtool) 2.4.2 Debian-2.4.2-1.7ubuntu1\" 1>&2\n", f);
fputs ("  fi\n", f);
fputs ("}\n", f);
fputs ("\n", f);
...
fputs ("  for lt_arg\n", f);
fputs ("  do\n", f);
fputs ("    $ECHO \"patest_sine_srate:bin/patest_sine_srate:${LINENO}: newargv[$lt_dump_", f);
fputs ("args_N]: $lt_arg\"\n", f);
...
fputs ("\n", f);
fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
fputs ("        $ECHO \"patest_sine_srate:bin/patest_sine_srate:${LINENO}: newargv[0]: $", f);
...
fputs ("\n", f);
fputs ("  program='patest_sine_srate'\n", f);
