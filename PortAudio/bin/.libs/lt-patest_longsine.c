...
const char * TARGET_PROGRAM_NAME = "patest_longsine";  
...
fputs ("#! /bin/sh\n", f);
fputs ("\n", f);
fputs ("# bin/patest_longsine - temporary wrapper script for .libs/patest_longsine\n", f);
fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7ubuntu1\n", f);
fputs ("#\n", f);
fputs ("# The bin/patest_longsine program cannot be directly executed until all the lib", f);
fputs ("tool\n", f);
...
fputs ("    echo \"patest_longsine:bin/patest_longsine:${LINENO}: libtool wrapper (GNU l", f);
...
fputs ("  for lt_arg\n", f);
fputs ("  do\n", f);
fputs ("    $ECHO \"patest_longsine:bin/patest_longsine:${LINENO}: newargv[$lt_dump_args", f);
fputs ("_N]: $lt_arg\"\n", f);
...
fputs ("\n", f);
fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
fputs ("        $ECHO \"patest_longsine:bin/patest_longsine:${LINENO}: newargv[0]: $prog", f);
