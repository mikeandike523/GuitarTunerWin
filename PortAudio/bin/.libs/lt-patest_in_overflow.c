...
const char * TARGET_PROGRAM_NAME = "patest_in_overflow";  
...
fputs ("#! /bin/sh\n", f);
fputs ("\n", f);
fputs ("# bin/patest_in_overflow - temporary wrapper script for .libs/patest_in_overflo", f);
fputs ("w\n", f);
fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7ubuntu1\n", f);
fputs ("#\n", f);
fputs ("# The bin/patest_in_overflow program cannot be directly executed until all the ", f);
fputs ("libtool\n", f);
...
fputs ("    echo \"patest_in_overflow:bin/patest_in_overflow:${LINENO}: libtool wrapper ", f);
fputs ("(GNU libtool) 2.4.2 Debian-2.4.2-1.7ubuntu1\" 1>&2\n", f);
fputs ("  fi\n", f);
fputs ("}\n", f);
fputs ("\n", f);
...
fputs ("  for lt_arg\n", f);
fputs ("  do\n", f);
fputs ("    $ECHO \"patest_in_overflow:bin/patest_in_overflow:${LINENO}: newargv[$lt_dum", f);
fputs ("p_args_N]: $lt_arg\"\n", f);
...
fputs ("\n", f);
fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
fputs ("        $ECHO \"patest_in_overflow:bin/patest_in_overflow:${LINENO}: newargv[0]:", f);
...
fputs ("\n", f);
fputs ("  program='patest_in_overflow'\n", f);
