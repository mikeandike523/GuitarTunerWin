...
const char * TARGET_PROGRAM_NAME = "patest_start_stop";  
...
fputs ("#! /bin/sh\n", f);
fputs ("\n", f);
fputs ("# bin/patest_start_stop - temporary wrapper script for .libs/patest_start_stop\n", f);
fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7ubuntu1\n", f);
fputs ("#\n", f);
fputs ("# The bin/patest_start_stop program cannot be directly executed until all the l", f);
fputs ("ibtool\n", f);
...
fputs ("    echo \"patest_start_stop:bin/patest_start_stop:${LINENO}: libtool wrapper (G", f);
...
fputs ("  for lt_arg\n", f);
fputs ("  do\n", f);
fputs ("    $ECHO \"patest_start_stop:bin/patest_start_stop:${LINENO}: newargv[$lt_dump_", f);
fputs ("args_N]: $lt_arg\"\n", f);
...
fputs ("\n", f);
fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
fputs ("        $ECHO \"patest_start_stop:bin/patest_start_stop:${LINENO}: newargv[0]: $", f);
...
fputs ("\n", f);
fputs ("  program='patest_start_stop'\n", f);
