...
const char * TARGET_PROGRAM_NAME = "patest_toomanysines";  
...
fputs ("#! /bin/sh\n", f);
fputs ("\n", f);
fputs ("# bin/patest_toomanysines - temporary wrapper script for .libs/patest_toomanysi", f);
fputs ("nes\n", f);
fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7ubuntu1\n", f);
fputs ("#\n", f);
fputs ("# The bin/patest_toomanysines program cannot be directly executed until all the", f);
fputs (" libtool\n", f);
...
fputs ("    echo \"patest_toomanysines:bin/patest_toomanysines:${LINENO}: libtool wrappe", f);
...
fputs ("  for lt_arg\n", f);
fputs ("  do\n", f);
fputs ("    $ECHO \"patest_toomanysines:bin/patest_toomanysines:${LINENO}: newargv[$lt_d", f);
...
fputs ("\n", f);
fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
fputs ("        $ECHO \"patest_toomanysines:bin/patest_toomanysines:${LINENO}: newargv[0", f);
...
fputs ("\n", f);
fputs ("  program='patest_toomanysines'\n", f);
