...
const char * TARGET_PROGRAM_NAME = "pa_fuzz";  
...
fputs ("#! /bin/sh\n", f);
fputs ("\n", f);
fputs ("# bin/pa_fuzz - temporary wrapper script for .libs/pa_fuzz\n", f);
fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7ubuntu1\n", f);
fputs ("#\n", f);
fputs ("# The bin/pa_fuzz program cannot be directly executed until all the libtool\n", f);
...
fputs ("    echo \"pa_fuzz:bin/pa_fuzz:${LINENO}: libtool wrapper (GNU libtool) 2.4.2 De", f);
...
fputs ("  for lt_arg\n", f);
fputs ("  do\n", f);
fputs ("    $ECHO \"pa_fuzz:bin/pa_fuzz:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
...
fputs ("\n", f);
fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
fputs ("        $ECHO \"pa_fuzz:bin/pa_fuzz:${LINENO}: newargv[0]: $progdir/$program\" 1>", f);
fputs ("&2\n", f);
