...
const char * TARGET_PROGRAM_NAME = "patest_leftright";  
...
fputs ("#! /bin/sh\n", f);
fputs ("\n", f);
fputs ("# bin/patest_leftright - temporary wrapper script for .libs/patest_leftright\n", f);
fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7ubuntu1\n", f);
fputs ("#\n", f);
fputs ("# The bin/patest_leftright program cannot be directly executed until all the li", f);
fputs ("btool\n", f);
...
fputs ("    echo \"patest_leftright:bin/patest_leftright:${LINENO}: libtool wrapper (GNU", f);
fputs (" libtool) 2.4.2 Debian-2.4.2-1.7ubuntu1\" 1>&2\n", f);
fputs ("  fi\n", f);
fputs ("}\n", f);
fputs ("\n", f);
...
fputs ("  for lt_arg\n", f);
fputs ("  do\n", f);
fputs ("    $ECHO \"patest_leftright:bin/patest_leftright:${LINENO}: newargv[$lt_dump_ar", f);
fputs ("gs_N]: $lt_arg\"\n", f);
...
fputs ("\n", f);
fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
fputs ("        $ECHO \"patest_leftright:bin/patest_leftright:${LINENO}: newargv[0]: $pr", f);
...
fputs ("\n", f);
fputs ("  program='patest_leftright'\n", f);
