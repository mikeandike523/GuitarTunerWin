...
const char * TARGET_PROGRAM_NAME = "paex_read_write_wire";  
...
fputs ("#! /bin/sh\n", f);
fputs ("\n", f);
fputs ("# bin/paex_read_write_wire - temporary wrapper script for .libs/paex_read_write", f);
fputs ("_wire\n", f);
fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7ubuntu1\n", f);
fputs ("#\n", f);
fputs ("# The bin/paex_read_write_wire program cannot be directly executed until all th", f);
fputs ("e libtool\n", f);
...
fputs ("    echo \"paex_read_write_wire:bin/paex_read_write_wire:${LINENO}: libtool wrap", f);
...
fputs ("  for lt_arg\n", f);
fputs ("  do\n", f);
fputs ("    $ECHO \"paex_read_write_wire:bin/paex_read_write_wire:${LINENO}: newargv[$lt", f);
...
fputs ("\n", f);
fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
fputs ("        $ECHO \"paex_read_write_wire:bin/paex_read_write_wire:${LINENO}: newargv", f);
...
fputs ("\n", f);
fputs ("  program='paex_read_write_wire'\n", f);
