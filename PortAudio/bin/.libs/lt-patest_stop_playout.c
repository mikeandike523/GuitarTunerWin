...
const char * TARGET_PROGRAM_NAME = "patest_stop_playout";  
...
fputs ("#! /bin/sh\n", f);
fputs ("\n", f);
fputs ("# bin/patest_stop_playout - temporary wrapper script for .libs/patest_stop_play", f);
fputs ("out\n", f);
fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7ubuntu1\n", f);
fputs ("#\n", f);
fputs ("# The bin/patest_stop_playout program cannot be directly executed until all the", f);
fputs (" libtool\n", f);
...
fputs ("    echo \"patest_stop_playout:bin/patest_stop_playout:${LINENO}: libtool wrappe", f);
fputs ("r (GNU libtool) 2.4.2 Debian-2.4.2-1.7ubuntu1\" 1>&2\n", f);
fputs ("  fi\n", f);
fputs ("}\n", f);
fputs ("\n", f);
...
fputs ("  for lt_arg\n", f);
fputs ("  do\n", f);
fputs ("    $ECHO \"patest_stop_playout:bin/patest_stop_playout:${LINENO}: newargv[$lt_d", f);
fputs ("ump_args_N]: $lt_arg\"\n", f);
...
fputs ("\n", f);
fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
fputs ("        $ECHO \"patest_stop_playout:bin/patest_stop_playout:${LINENO}: newargv[0", f);
fputs ("]: $progdir/$program\" 1>&2\n", f);
...
fputs ("\n", f);
fputs ("  program='patest_stop_playout'\n", f);
