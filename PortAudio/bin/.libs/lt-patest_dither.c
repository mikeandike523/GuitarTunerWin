...
const char * TARGET_PROGRAM_NAME = "patest_dither";  
...
fputs ("#! /bin/sh\n", f);
fputs ("\n", f);
fputs ("# bin/patest_dither - temporary wrapper script for .libs/patest_dither\n", f);
fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7ubuntu1\n", f);
fputs ("#\n", f);
fputs ("# The bin/patest_dither program cannot be directly executed until all the libto", f);
fputs ("ol\n", f);
...
fputs ("    echo \"patest_dither:bin/patest_dither:${LINENO}: libtool wrapper (GNU libto", f);
...
fputs ("  for lt_arg\n", f);
fputs ("  do\n", f);
fputs ("    $ECHO \"patest_dither:bin/patest_dither:${LINENO}: newargv[$lt_dump_args_N]:", f);
fputs (" $lt_arg\"\n", f);
...
fputs ("\n", f);
fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
fputs ("        $ECHO \"patest_dither:bin/patest_dither:${LINENO}: newargv[0]: $progdir/", f);
fputs ("$program\" 1>&2\n", f);
