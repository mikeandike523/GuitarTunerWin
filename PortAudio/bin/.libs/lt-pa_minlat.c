...
const char * TARGET_PROGRAM_NAME = "pa_minlat";  
...
fputs ("#! /bin/sh\n", f);
fputs ("\n", f);
fputs ("# bin/pa_minlat - temporary wrapper script for .libs/pa_minlat\n", f);
fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7ubuntu1\n", f);
fputs ("#\n", f);
fputs ("# The bin/pa_minlat program cannot be directly executed until all the libtool\n", f);
...
fputs ("    echo \"pa_minlat:bin/pa_minlat:${LINENO}: libtool wrapper (GNU libtool) 2.4.", f);
...
fputs ("  for lt_arg\n", f);
fputs ("  do\n", f);
fputs ("    $ECHO \"pa_minlat:bin/pa_minlat:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg", f);
fputs ("\"\n", f);
...
fputs ("\n", f);
fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
fputs ("        $ECHO \"pa_minlat:bin/pa_minlat:${LINENO}: newargv[0]: $progdir/$program", f);
fputs ("\" 1>&2\n", f);
