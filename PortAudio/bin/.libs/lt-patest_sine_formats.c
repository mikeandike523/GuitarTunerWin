...
const char * TARGET_PROGRAM_NAME = "patest_sine_formats";  
...
fputs ("#! /bin/sh\n", f);
fputs ("\n", f);
fputs ("# bin/patest_sine_formats - temporary wrapper script for .libs/patest_sine_form", f);
fputs ("ats\n", f);
fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7ubuntu1\n", f);
fputs ("#\n", f);
fputs ("# The bin/patest_sine_formats program cannot be directly executed until all the", f);
fputs (" libtool\n", f);
...
fputs ("    echo \"patest_sine_formats:bin/patest_sine_formats:${LINENO}: libtool wrappe", f);
...
fputs ("  for lt_arg\n", f);
fputs ("  do\n", f);
fputs ("    $ECHO \"patest_sine_formats:bin/patest_sine_formats:${LINENO}: newargv[$lt_d", f);
...
fputs ("\n", f);
fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
fputs ("        $ECHO \"patest_sine_formats:bin/patest_sine_formats:${LINENO}: newargv[0", f);
...
fputs ("\n", f);
fputs ("  program='patest_sine_formats'\n", f);
