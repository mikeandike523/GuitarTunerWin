...
const char * TARGET_PROGRAM_NAME = "paex_record";  
...
fputs ("#! /bin/sh\n", f);
fputs ("\n", f);
fputs ("# bin/paex_record - temporary wrapper script for .libs/paex_record\n", f);
fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7ubuntu1\n", f);
fputs ("#\n", f);
fputs ("# The bin/paex_record program cannot be directly executed until all the libtool\n", f);
...
fputs ("    echo \"paex_record:bin/paex_record:${LINENO}: libtool wrapper (GNU libtool) ", f);
...
fputs ("  for lt_arg\n", f);
fputs ("  do\n", f);
fputs ("    $ECHO \"paex_record:bin/paex_record:${LINENO}: newargv[$lt_dump_args_N]: $lt", f);
fputs ("_arg\"\n", f);
...
fputs ("\n", f);
fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
fputs ("        $ECHO \"paex_record:bin/paex_record:${LINENO}: newargv[0]: $progdir/$pro", f);
fputs ("gram\" 1>&2\n", f);
