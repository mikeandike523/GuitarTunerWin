...
const char * TARGET_PROGRAM_NAME = "patest1";  
...
fputs ("#! /bin/sh\n", f);
fputs ("\n", f);
fputs ("# bin/patest1 - temporary wrapper script for .libs/patest1\n", f);
fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7ubuntu1\n", f);
fputs ("#\n", f);
fputs ("# The bin/patest1 program cannot be directly executed until all the libtool\n", f);
...
fputs ("    echo \"patest1:bin/patest1:${LINENO}: libtool wrapper (GNU libtool) 2.4.2 De", f);
fputs ("bian-2.4.2-1.7ubuntu1\" 1>&2\n", f);
fputs ("  fi\n", f);
fputs ("}\n", f);
fputs ("\n", f);
...
fputs ("  for lt_arg\n", f);
fputs ("  do\n", f);
fputs ("    $ECHO \"patest1:bin/patest1:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
...
fputs ("\n", f);
fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
fputs ("        $ECHO \"patest1:bin/patest1:${LINENO}: newargv[0]: $progdir/$program\" 1>", f);
fputs ("&2\n", f);
