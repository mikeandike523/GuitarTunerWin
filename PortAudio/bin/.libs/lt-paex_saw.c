...
const char * TARGET_PROGRAM_NAME = "paex_saw";  
...
fputs ("#! /bin/sh\n", f);
fputs ("\n", f);
fputs ("# bin/paex_saw - temporary wrapper script for .libs/paex_saw\n", f);
fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7ubuntu1\n", f);
fputs ("#\n", f);
fputs ("# The bin/paex_saw program cannot be directly executed until all the libtool\n", f);
...
fputs ("    echo \"paex_saw:bin/paex_saw:${LINENO}: libtool wrapper (GNU libtool) 2.4.2 ", f);
fputs ("Debian-2.4.2-1.7ubuntu1\" 1>&2\n", f);
fputs ("  fi\n", f);
fputs ("}\n", f);
fputs ("\n", f);
...
fputs ("  for lt_arg\n", f);
fputs ("  do\n", f);
fputs ("    $ECHO \"paex_saw:bin/paex_saw:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
...
fputs ("\n", f);
fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
fputs ("        $ECHO \"paex_saw:bin/paex_saw:${LINENO}: newargv[0]: $progdir/$program\" ", f);
fputs ("1>&2\n", f);
