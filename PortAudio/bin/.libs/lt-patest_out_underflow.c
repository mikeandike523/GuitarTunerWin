...
const char * TARGET_PROGRAM_NAME = "patest_out_underflow";  
...
fputs ("#! /bin/sh\n", f);
fputs ("\n", f);
fputs ("# bin/patest_out_underflow - temporary wrapper script for .libs/patest_out_unde", f);
fputs ("rflow\n", f);
fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7ubuntu1\n", f);
fputs ("#\n", f);
fputs ("# The bin/patest_out_underflow program cannot be directly executed until all th", f);
fputs ("e libtool\n", f);
...
fputs ("    echo \"patest_out_underflow:bin/patest_out_underflow:${LINENO}: libtool wrap", f);
fputs ("per (GNU libtool) 2.4.2 Debian-2.4.2-1.7ubuntu1\" 1>&2\n", f);
fputs ("  fi\n", f);
fputs ("}\n", f);
fputs ("\n", f);
...
fputs ("  for lt_arg\n", f);
fputs ("  do\n", f);
fputs ("    $ECHO \"patest_out_underflow:bin/patest_out_underflow:${LINENO}: newargv[$lt", f);
fputs ("_dump_args_N]: $lt_arg\"\n", f);
...
fputs ("\n", f);
fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
fputs ("        $ECHO \"patest_out_underflow:bin/patest_out_underflow:${LINENO}: newargv", f);
fputs ("[0]: $progdir/$program\" 1>&2\n", f);
...
fputs ("\n", f);
fputs ("  program='patest_out_underflow'\n", f);
