...
#endif
const char *program_name = "libtool-wrapper";  
...
const char * LIB_PATH_VALUE   = "d:\\Projects\\CrunchyRig\\portaudio\\lib\\.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "d:\\Projects\\CrunchyRig\\portaudio\\lib\\.libs;D:\\Projects\\CrunchyRig\\MinGW\\msys\\1.0\\local\\lib;D:\\Projects\\CrunchyRig\\MinGW\\msys\\1.0\\local\\bin;";
const char * TARGET_PROGRAM_NAME = "patest_sine_channelmaps";  
...
XFREE (actual_cwrapper_name);
lt_setenv ("BIN_SH", "xpg4");  
lt_setenv ("DUALCASE", "1");   
...
fputs ("#! /bin/sh\n", f);
fputs ("\n", f);
fputs ("# bin/patest_sine_channelmaps - temporary wrapper script for .libs/patest_sine_", f);
fputs ("channelmaps\n", f);
fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7ubuntu1\n", f);
fputs ("#\n", f);
fputs ("# The bin/patest_sine_channelmaps program cannot be directly executed until all", f);
fputs (" the libtool\n", f);
...
fputs ("  notinst_deplibs=' lib/libportaudio.la'\n", f);
fputs ("else\n", f);
...
fputs ("    echo \"patest_sine_channelmaps:bin/patest_sine_channelmaps:${LINENO}: libtoo", f);
fputs ("l wrapper (GNU libtool) 2.4.2 Debian-2.4.2-1.7ubuntu1\" 1>&2\n", f);
fputs ("  fi\n", f);
fputs ("}\n", f);
fputs ("\n", f);
...
fputs ("  for lt_arg\n", f);
fputs ("  do\n", f);
fputs ("    $ECHO \"patest_sine_channelmaps:bin/patest_sine_channelmaps:${LINENO}: newar", f);
fputs ("gv[$lt_dump_args_N]: $lt_arg\"\n", f);
...
fputs ("\n", f);
fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
fputs ("        $ECHO \"patest_sine_channelmaps:bin/patest_sine_channelmaps:${LINENO}: n", f);
fputs ("ewargv[0]: $progdir/$program\" 1>&2\n", f);
...
fputs ("\n", f);
fputs ("  program='patest_sine_channelmaps'\n", f);
...
fputs ("    PATH=/d/Projects/CrunchyRig/portaudio/lib/.libs:/usr/local/lib:/usr/local/b", f);
fputs ("in:$PATH\n", f);
fputs ("\n", f);
fputs ("    # Add our own library path to PATH\n", f);
fputs ("    PATH=\"/d/Projects/CrunchyRig/portaudio/lib/.libs:$PATH\"\n", f);
fputs ("\n", f);
