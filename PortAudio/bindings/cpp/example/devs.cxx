...
if (printCount == 0)
{
std::cout << "    " << STANDARD_SAMPLE_RATES[i];  
printCount = 1;
}
...
std::cout << "Default low input latency   = " << (*i).defaultLowInputLatency() << std::endl;  
std::cout << "Default low output latency  = " << (*i).defaultLowOutputLatency() << std::endl;  
std::cout << "Default high input latency  = " << (*i).defaultHighInputLatency() << std::endl;  
std::cout << "Default high output latency = " << (*i).defaultHighOutputLatency() << std::endl;  
#ifdef WIN32
...
#endif  
std::cout << "Default sample rate         = " << (*i).defaultSampleRate() << std::endl;  
