...
if (item_type == 9) { ret = ImGui::Selectable("ITEM: Selectable"); }                             
if (item_type == 10){ ret = ImGui::MenuItem("ITEM: MenuItem"); }                                 
if (item_type == 11){ ret = ImGui::TreeNode("ITEM: TreeNode"); if (ret) ImGui::TreePop(); }      
if (item_type == 12){ ret = ImGui::TreeNodeEx("ITEM: TreeNode w/ ImGuiTreeNodeFlags_OpenOnDoubleClick", ImGuiTreeNodeFlags_OpenOnDoubleClick | ImGuiTreeNodeFlags_NoTreePushOnOpen); }  
...
ImGui::Text("Pen Pressure: %.1f", io.PenPressure);  
ImGui::TreePop();
}
